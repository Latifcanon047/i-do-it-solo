...
> = {
  ...
  expired: {
    text: "Link verifikasi sudah kadaluarsa. Silakan daftar ulang.",
    type: "error",
  },
  invalid: { text: "Link verifikasi tidak valid.", type: "error" },
  missing_token: { text: "Link verifikasi tidak lengkap.", type: "error" },
};
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (result?.error) {
      if (result.error === "email_not_verified") {
        setError(
          "Email kamu belum diverifikasi. Cek inbox atau spam untuk link verifikasi.",
        );
      } else {
